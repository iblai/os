...
vi.mock('@/components/chat/chat-messages', () => ({
  ChatMessages: ({
    ...
    <div data-testid="chat-messages">
      ...
      <button data-testid="submit-from-messages" onClick={() => handleSubmit('test message')}>
...
vi.mock('@/components/chat/loading-message', () => ({
  LoadingMessage: ({ mentorName, profileImage }: { mentorName: string; profileImage: string }) => (
...
describe('WorkflowPreviewChat', () => {
  ...
  describe('props passing', () => {
    ...
    it('should pass mentorId to ChatInputForm', () => {
      render(<WorkflowPreviewChat {...defaultProps} />);
      expect(screen.getByTestId('mentor-id')).toHaveTextContent('test-mentor-id');
    });
  ...
  describe('message handling', () => {
    it('should call sendMessage when form is submitted', async () => {
      ...
      expect(mockSendMessage).toHaveBeenCalledWith('chat', 'Hello', { visible: true });
    });
  ...
  describe('username and token handling', () => {
    it('should pass anonymous username when username is null', async () => {
      ...
      vi.mocked<any>(useAdvancedChat).mockImplementation((options: { username?: string }) => {
    ...
    it('should pass empty string for token when useAxdToken returns null', async () => {
      ...
      vi.mocked<any>(useAdvancedChat).mockImplementation((options: { token?: string }) => {
  ...
  describe('useAdvancedChat configuration', () => {
    it('should pass correct wsUrl to useAdvancedChat', async () => {
      ...
      vi.mocked<any>(useAdvancedChat).mockImplementation((options: { wsUrl?: string }) => {
    ...
    it('should pass mentorId to useAdvancedChat', async () => {
      ...
      vi.mocked<any>(useAdvancedChat).mockImplementation((options: { mentorId?: string }) => {
    ...
    it('should pass tenantKey to useAdvancedChat', async () => {
      ...
      vi.mocked<any>(useAdvancedChat).mockImplementation((options: { tenantKey?: string }) => {
        ...
        ChatInputForm: (props: {
          ...
          return (
            <div data-testid="chat-input-form-noop">
              ...
              <button data-testid="test-phone-call-click" onClick={() => props.onPhoneCallClick()}>
                Phone Call
              </button>
              <button
              ...
              <button data-testid="test-set-session-tools" onClick={() => props.setSessionTools()}>
                Set Tools
              </button>
            </div>
          );
