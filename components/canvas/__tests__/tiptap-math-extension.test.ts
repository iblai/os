...
describe('tiptap-math-extension', () => {
  ...
  describe('MathInline', () => {
    ...
    describe('addAttributes', () => {
      it('should define latex attribute with default empty string', () => {
        const attrs = MathInline.config.addAttributes!.call(
          MathInline as any,
        ) as any;
    ...
    describe('parseHTML', () => {
      it('should match span[data-math-latex] without data-math-display', () => {
        ...
        expect(rules[0].tag).toBe(
          'span[data-math-latex]:not([data-math-display])',
        );
      });
    ...
    describe('addNodeView', () => {
      it('should create a span with rendered KaTeX content', () => {
        ...
        const nodeViewFactory = MathInline.config.addNodeView!.call(
          MathInline as any,
        );
  ...
  describe('MathBlock', () => {
    ...
    describe('addAttributes', () => {
      it('should define latex attribute with default empty string', () => {
        const attrs = MathBlock.config.addAttributes!.call(
          MathBlock as any,
        ) as any;
        expect(attrs.latex.default).toBe('');
      });
    ...
    describe('addNodeView', () => {
      it('should create a span with display:block and rendered KaTeX', () => {
        ...
        const nodeViewFactory = MathBlock.config.addNodeView!.call(
          MathBlock as any,
        );
        const nodeView = (nodeViewFactory as any)({
