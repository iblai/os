...
describe('tiptap-math-extension', () => {
  ...
  describe('MathInline', () => {
    ...
    describe('addAttributes', () => {
      it('should define latex attribute with default empty string', () => {
        const attrs = MathInline.config.addAttributes!.call(MathInline as any) as any;
    ...
    describe('parseHTML', () => {
      it('should match span[data-math-latex] without data-math-display', () => {
        const rules = MathInline.config.parseHTML!.call(MathInline as any)!;
    ...
    describe('renderHTML', () => {
      it('should output span with data-math-latex attribute', () => {
        ...
        const result = renderHTML.call(MathInline as any, {
    ...
    describe('addNodeView', () => {
      it('should create a span with rendered KaTeX content', () => {
        ...
        const nodeViewFactory = MathInline.config.addNodeView!.call(MathInline as any);
  ...
  describe('MathBlock', () => {
    ...
    describe('addAttributes', () => {
      it('should define latex attribute with default empty string', () => {
        const attrs = MathBlock.config.addAttributes!.call(MathBlock as any) as any;
        expect(attrs.latex.default).toBe('');
      });
    ...
    describe('parseHTML', () => {
      it('should match span[data-math-latex][data-math-display]', () => {
        const rules = MathBlock.config.parseHTML!.call(MathBlock as any)!;
    ...
    describe('renderHTML', () => {
      it('should output span with data-math-latex and data-math-display', () => {
        ...
        const result = renderHTML.call(MathBlock as any, {
    ...
    describe('addNodeView', () => {
      it('should create a span with display:block and rendered KaTeX', () => {
        ...
        const nodeViewFactory = MathBlock.config.addNodeView!.call(MathBlock as any);
        const nodeView = (nodeViewFactory as any)({
