...
export function GraderTab() {
  ...
  const labels: GraderTabLabels = {
    ...
    results: {
      sectionTitle: t('resultsSectionTitle'),
      description: t('resultsDescription'),
      filters: {
        searchUser: t('resultsFilterSearchUser'),
        searchUsersPlaceholder: t('resultsFilterSearchUsersPlaceholder'),
        noUsersFound: t('resultsFilterNoUsersFound'),
        allUsers: t('resultsFilterAllUsers'),
        statusLabel: t('resultsFilterStatusLabel'),
        dateRangeLabel: t('resultsFilterDateRangeLabel'),
        allStatuses: t('resultsFilterAllStatuses'),
      },
      statusValues: {
        pending: t('resultsStatusPending'),
        published: t('resultsStatusPublished'),
        failed: t('resultsStatusFailed'),
      },
      columns: {
        learner: t('resultsColumnLearner'),
        score: t('resultsColumnScore'),
        status: t('resultsColumnStatus'),
        override: t('resultsColumnOverride'),
        gradedAt: t('resultsColumnGradedAt'),
      },
      emptyState: t('resultsEmptyState'),
      emptyFiltered: t('resultsEmptyFiltered'),
      overriddenBadge: t('resultsOverriddenBadge'),
      overrideButton: t('resultsOverrideButton'),
      overrideButtonAria: (email: string) =>
        t('resultsOverrideButtonAria', { email }),
      overrideModal: {
        title: t('overrideModalTitle'),
        learnerLabel: t('overrideModalLearnerLabel'),
        aiScoreLabel: t('overrideModalAiScoreLabel'),
        currentOverrideLabel: t('overrideModalCurrentOverrideLabel'),
        noOverride: t('overrideModalNoOverride'),
        pointsLabel: t('overrideModalPointsLabel'),
        pointsHelp: t.raw('overrideModalPointsHelp'),
        pointsRange: t.raw('overrideModalPointsRange'),
        feedbackLabel: t('overrideModalFeedbackLabel'),
        feedbackPlaceholder: t('overrideModalFeedbackPlaceholder'),
        clearHelp: t('overrideModalClearHelp'),
        save: t('overrideModalSave'),
        saving: t('overrideModalSaving'),
        clear: t('overrideModalClear'),
        clearing: t('overrideModalClearing'),
        cancel: t('overrideModalCancel'),
      },
      toasts: {
        overrideSaved: t('toastOverrideSaved'),
        overrideCleared: t('toastOverrideCleared'),
        overrideError: t('toastOverrideError'),
      },
    },
    toasts: {
