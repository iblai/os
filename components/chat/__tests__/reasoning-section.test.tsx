...
describe("ReasoningSection", () => {
  ...
  describe("auto-open/close", () => {
    it("auto-opens when reasoning starts", () => {
      const { rerender } = render(
        <ReasoningSection reasoningContent="" isReasoning={false} />,
      );

      rerender(
        <ReasoningSection reasoningContent="thinking..." isReasoning={true} />,
      );
      // Should be open — markdown content visible
      expect(screen.getByTestId("markdown")).toBeVisible();
    });

    it("auto-collapses when reasoning completes", () => {
      const { rerender } = render(
        <ReasoningSection
    ...
    it("can be manually reopened after auto-collapse", () => {
      const { rerender } = render(
        <ReasoningSection reasoningContent="reasoning" isReasoning={true} />,
      );
