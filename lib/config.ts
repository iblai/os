const env = {
  ...
  NEXT_PUBLIC_EXTERNAL_PRICING_PAGE_URL: process.env.NEXT_PUBLIC_EXTERNAL_PRICING_PAGE_URL,
  ...
  NEXT_PUBLIC_IBL_LIVE_KIT_SERVER_URL: process.env.NEXT_PUBLIC_IBL_LIVE_KIT_SERVER_URL,
  NEXT_PUBLIC_MENTOR_URL: process.env.NEXT_PUBLIC_MENTOR_URL,
  NEXT_PUBLIC_MENTOR_SETTINGS_DISCLAIMER: process.env.NEXT_PUBLIC_MENTOR_SETTINGS_DISCLAIMER,
  NEXT_PUBLIC_IFRAME_FROM_OLD_MENTOR: process.env.NEXT_PUBLIC_IFRAME_FROM_OLD_MENTOR,
  ...
  NEXT_PUBLIC_DEFAULT_EMBED_CSS_URL: process.env.NEXT_PUBLIC_DEFAULT_EMBED_CSS_URL,
  NEXT_PUBLIC_APP_BANNER_LINK: process.env.NEXT_PUBLIC_APP_BANNER_LINK,
  NEXT_PUBLIC_APP_BANNER_LINK_TEXT: process.env.NEXT_PUBLIC_APP_BANNER_LINK_TEXT,
  ...
  NEXT_PUBLIC_DISABLED_ANALYTICS_REPORTS: process.env.NEXT_PUBLIC_DISABLED_ANALYTICS_REPORTS,
...
export const config = {
  ...
  lmsUrl: () => getEnv('NEXT_PUBLIC_LMS_URL', 'https://learn.iblai.org'),
  dmUrl: () => getEnv('NEXT_PUBLIC_DM_URL', 'https://base.manager.iblai.org'),
  axdUrl: () => getEnv('NEXT_PUBLIC_AXD_URL', 'https://base.manager.iblai.org'),
  mainTenantKey: () => getEnv('NEXT_PUBLIC_MAIN_TENANT_KEY', 'main'),
  iblTemplateMentor: () => getEnv('NEXT_PUBLIC_IBL_TEMPLATE_MENTOR', 'ai-mentor'),
  ...
  mentorIframeUrl: () => getEnv('NEXT_PUBLIC_MENTOR_IFRAME_URL', 'https://mentor.iblai.org'),
  ...
  baseWsUrl: () => getEnv('NEXT_PUBLIC_BASE_WS_URL', 'https://asgi.data.iblai.org'),
  liveKitServerUrl: () =>
    getEnv('NEXT_PUBLIC_IBL_LIVE_KIT_SERVER_URL', 'wss://livekit.call.iblai.org'),
  mentorSettingsDisclaimer: () => getEnv('NEXT_PUBLIC_MENTOR_SETTINGS_DISCLAIMER', ''),
  iframeFromOldMentor: () => getEnv('NEXT_PUBLIC_IFRAME_FROM_OLD_MENTOR', 'false'),
  ...
  helpCenterUrl: () => getEnv('NEXT_PUBLIC_HELP_CENTER_URL', 'https://docs.ibl.ai'),
  ...
  appBannerLink: () => getEnv('NEXT_PUBLIC_APP_BANNER_LINK', 'https://docs.ibl.ai'),
  appBannerLinkText: () => getEnv('NEXT_PUBLIC_APP_BANNER_LINK_TEXT', 'View all'),
  appBannerBadge: () => getEnv('NEXT_PUBLIC_APP_BANNER_BADGE', 'New'),
  appBannerText: () =>
    getEnv('NEXT_PUBLIC_APP_BANNER_TEXT', 'Explore our latest features for students'),
  ...
  showBaseMentor: () => getEnv('NEXT_PUBLIC_SHOW_BASE_MENTOR', 'false') === 'true',
  disabedDatasets: () => getEnv('NEXT_PUBLIC_DISABLED_DATASETS', 'zip|courses'),
  advertisingEnabled: () => getEnv('NEXT_PUBLIC_ENABLE_ADVERTISING', 'false') === 'true',
