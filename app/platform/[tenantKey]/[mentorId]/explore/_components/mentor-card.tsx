...
export function MentorCard({ mentor }: MentorCardProps) {
  ...
  return (
    <button
      className="flex w-full h-full cursor-pointer items-center gap-4 overflow-hidden rounded-lg border border-gray-200 bg-white p-2 py-4 text-left transition-colors hover:border-blue-500 focus:border-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:ring-offset-1 sm:gap-3 sm:p-3 md:p-4"
      onClick={handleClick}
