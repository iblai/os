...
> Last updated: 2026-08-05 | 614 checkpoints (583 covered, 8 pending/fixme, 11 not-reproducible in default env, 12 deprecated) | 68 journeys (67 active, 1 deprecated in #1431) | 100% covered | Auth: admin + non-admin storageState
...
- [x] grd-03: Gated content splits into the Grading setup, Rubric, and Results sub-tabs — all three pills are visible and switching between Grading setup and Rubric renders the matching section (`grader-setup-section` / `grader-criteria-section`)
- [x] grd-04: The Results sub-tab renders its own grade-results table and shows the zero-filters empty state ("No grades yet…") on a mentor with no graded submissions yet; independent of a saved config or rubric
