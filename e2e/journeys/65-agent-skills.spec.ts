...
test.describe('Journey 65: Agent Skills — Edit Mentor Skills tab gating', () => {
...
test.describe('Journey 65: Agent Skills — chat composer slash skill picker', () => {
  test.describe.configure({ mode: 'parallel' });
