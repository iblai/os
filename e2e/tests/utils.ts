...
import { closeWithEsc, safeWaitForURL } from "@iblai/iblai-js/playwright";
...
export async function uploadDataOnTheDataSet(page: Page) {
  ...
  const resources = [
    ...
    {
      type: "DOCX",
      path: path.resolve(__dirname, "../files/testing_folder/audrey.docx"),
      name: "audrey.docx",
    },
    {
      type: "PowerPoint",
      path: path.resolve(__dirname, "../files/testing_folder/ppt1FC3.pptm"),
      name: "ppt1FC3.pptm",
    },
    {
      type: "TXT",
      path: path.resolve(__dirname, "../files/testing_folder/outerHTML.txt"),
      name: "outerHTML.txt",
    },
    {
      type: "CSV",
