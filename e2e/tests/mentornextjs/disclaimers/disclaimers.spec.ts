...
test.describe.skip('Disclaimers Tab Tests', () => {
  ...
  test('Create new mentor and configure disclaimers', async ({ page }) => {
    const isAdmin = await checkAdminStatus(page);
    test.skip(!isAdmin, 'Test requires admin access');
    ...
    console.log('Successfully configured disclaimers for new mentor');
